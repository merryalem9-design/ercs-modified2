      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5">
        ...
        <DashboardKPICard
          ...
          badge={{
            ...
            color: (beneficiariesTargeted > 0 && (beneficiariesReached / beneficiariesTargeted) >= 0.8)
              ? 'bg-emerald-100 text-emerald-800 border-emerald-300'
              : (beneficiariesTargeted > 0 && (beneficiariesReached / beneficiariesTargeted) >= 0.6)
        ...
        <DashboardKPICard
          ...
          badge={{
            ...
            color: objStatusCounts['off-track'] > 0
              ? 'bg-rose-100 text-rose-800 border-rose-300'
              : objStatusCounts['at-risk'] > 0
              ? 'bg-amber-100 text-amber-800 border-amber-300'
              : 'bg-emerald-100 text-emerald-800 border-emerald-300',
          }}
        />
